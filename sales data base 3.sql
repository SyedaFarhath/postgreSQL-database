...
ALTER TABLE customer ALTER COLUMN zip TYPE BIGINT;


INSERT INTO customer (first_name, last_name, email, company, street, city, state, zip, phone, birt_date, sex, date_entered) VALUES 
...
INSERT INTO sales_person (first_name, last_name, email, street, city, state, zip, phone, birt_date, sex, date_hired) VALUES 
...
--  main operations starting from here -----------------------------
